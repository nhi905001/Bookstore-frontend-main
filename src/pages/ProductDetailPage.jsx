...
// 👉 Dùng backend cart API
import { addToCart as addCartAPI } from "../api/cartService";
...
const ProductDetailPage = () => {
  ...
  const handleAddToCart = async () => {
    ...
    try {
      await addCartAPI(product._id, quantity, token);
  ...
  if (loading) {
    return (
      <div className="container mx-auto text-center py-12">Đang tải...</div>
    );
  }

  if (error) {
    return (
      <div className="container mx-auto text-center py-12 text-red-500">
        {error}
      </div>
    );
  }
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-start">
          ...
          <div className="flex flex-col h-full">
            ...
            <Link
              ...
              className="inline-block bg-blue-100 text-blue-800 text-sm font-semibold mb-4 px-3 py-1 rounded-full hover:bg-blue-200 self-start"
            >
              {product.category}
            </Link>
            ...
            <div className="mb-6">
              {product.salePrice ? (
                <div>
                  ...
                  <span className="text-4xl font-bold text-blue-600 ml-4">
